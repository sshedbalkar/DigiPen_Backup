...
_DECLSPEC_ALIGN_16_ class OrientedBox
{
public:
    XMFLOAT3 Center;            // Center of the box.
    XMFLOAT3 Extents;           // Distance from the center to each side.
    XMFLOAT4 Orientation;       // Unit quaternion representing rotation (box -> world).
	inline OrientedBox() : Center(0, 0, 0), Extents(0,0,0), Orientation(0,0,0,1){}
	inline OrientedBox( const D3DXVECTOR3& _center, const D3DXVECTOR3& _scale, const D3DXQUATERNION& _orien)
		: Center(_center.x, _center.y, _center.z), Extents(_scale.x, _scale.y, _scale.z), Orientation(_orien.x, _orien.y, _orien.z, _orien.w){}
};
