...
public:
	Singleton( void )
	{
		MCR_Assert( ms_Singleton == 0, "Singleton constructor" );
		intptr_t offset = (intptr_t)(T*)1 - (intptr_t)(Singleton <T> *)(T*)1;
		ms_Singleton = (T*)((intptr_t)this + offset);
	}
	~Singleton( void )  {  MCR_Assert( ms_Singleton != 0, "Singleton destructor" ); 
ms_Singleton = 0;  }

	static T&   GetSingleton      ( void )  {  MCR_Assert( ms_Singleton != 0, "Singleton - GetSingleton" );  return ( *ms_Singleton );  }
