...
void Graphics::SetGraphicsOptions(MenuOptions* opt)
{
	m_D3D->VSYNC = opt->Vsync;

	AA = opt->Antialiasing;

	m_D3D->FULLSCREEN = !opt->Windowed;
...
Deferred* Graphics::GetDeferred() { return Def; };
