...
public:
	...
	Mallocator() { /*std::cout<<"Mallocator: 1\n";*/ }
	~Mallocator() { /*std::cout<<"Mallocator: dtor\n";*/ }
	Mallocator( const Mallocator& ) { /*std::cout<<"Mallocator: 2\n";*/ }
	Mallocator& operator=( const Mallocator& ) { /*std::cout<<"Mallocator: 3\n";*/ return *this; }
	template <class U> Mallocator( const Mallocator<U>& ) { /*std::cout<<"Mallocator: 4\n";*/ }
	//
public:
	// Type Definitions
