...
bool BitmapClass::InitializeBuffers(ID3D11Device* device)
{
	...
	vertices = new ModelVertex[m_vertexCount];
	if(!vertices)
	{
		return false;
	}
	...
	memset(vertices, 0, (sizeof(ModelVertex) * m_vertexCount));
    ...
    vertexBufferDesc.ByteWidth = sizeof(ModelVertex) * m_vertexCount;
...
bool BitmapClass::UpdateBuffers(ID3D11DeviceContext* deviceContext, int positionX, int positionY)
{
	...
	verticesPtr = (ModelVertex*)mappedResource.pData;

	// Copy the data into the vertex buffer.
	memcpy(verticesPtr, (void*)vertices, (sizeof(ModelVertex) * m_vertexCount));
