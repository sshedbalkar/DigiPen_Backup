...
namespace GLEED2D.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to (Left Click) = add circle to root      (Right Click) = cancel circle.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to There is no layer in the root. Please add a new layer before adding items..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to (Left Click) = next point      (BackSpace) = delete last point      (Middle Click) = add path to root      (Right Click) = cancel path.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to (Left Click) = add rectangle to root      (LeftCtrl) = make square      (Right Click) = cancel rectangle.
        /// </summary>
