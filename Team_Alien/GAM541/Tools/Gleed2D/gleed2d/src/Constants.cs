...
namespace GLEED2D
{
    ...
    public class Constants
    {
        ...
        [Editor(typeof(XNAColorUITypeEditor), typeof(System.Drawing.Design.UITypeEditor))]
        [Category("General"), Description("The default color each new Primitive gets when added to the root.")]
        ...
        [Category("General"), Description("The default LineWidth of each new PathItem added to the root.")]
        ...
        [Category("General"), Description("When a new root is created, its ContentrootFolder will be initially set to this.")]
        ...
        public bool RunrootStartApplication;
        public string RunrootApplicationToStart;
        public bool RunrootAppendrootFilename;


        public bool SaverootStartApplication;
        public string SaverootApplicationToStart;
        public bool SaverootAppendrootFilename;
