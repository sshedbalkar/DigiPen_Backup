...
namespace GLEED2D
{
    public partial class PathItem
    {
            ...
            : base()
        {
            ...
            for (int i = 0; i < LocalPoints.Length; i++) LocalPoints[i] -= PositionOrig;
        ...
        {
            for (int i = 0; i < WorldPoints.Length; i++) WorldPoints[i] = LocalPoints[i] + PositionOrig;
        }
        ...
        public override void setPosition(Vector2 pos)
        {
            if (pointgrabbed >= 0)
            {
                LocalPoints[pointgrabbed] = initialpos + pos - PositionOrig * 2;
                OnTransformed();
