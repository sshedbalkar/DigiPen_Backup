...
//======================================
BossAnimationEffect::~BossAnimationEffect()
{
}
//======================================
void BossAnimationEffect::Initialize( GameObjectComposition* object )
{
...
//======================================
void BossAnimationEffect::Update( float timeslice )
{
	...
	case STATE_STANDING:
		...
		{
		case ON_ENTER:
			mesh->SetAnimation( "boss_standing", true );
	...
	case STATE_WALKING:
		...
		{
		case ON_ENTER:
			mesh->SetAnimation( "boss_walking", true );
			inner_state = ON_UPDATE;
			break;
		case ON_UPDATE:
			if ( abs( body->Velocity.x ) < 0.2f  )
...
//======================================
void BossAnimationEffect::SendMessage( Message* msg ){}
