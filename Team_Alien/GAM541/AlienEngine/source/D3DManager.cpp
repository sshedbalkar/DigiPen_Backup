...
{
	if( swap_chain ) swap_chain->SetFullscreenState(false, NULL);
...
{ device->RSSetViewports( 1, &viewport ); }
//==================================================
void D3DManager::SetViewport2()
{ device->RSSetViewports( 1, &viewport2 ); }
//==================================================
void D3DManager::SetViewport4()
{ device->RSSetViewports( 1, &viewport4 ); }
//==================================================
void D3DManager::SetViewport8()
{ device->RSSetViewports( 1, &viewport8 ); }
//==================================================
